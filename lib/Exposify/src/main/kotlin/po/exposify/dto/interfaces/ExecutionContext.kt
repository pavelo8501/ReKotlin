...
interface ExecutionContext<DTO: ModelDTO, DATA: DataModel, ENTITY: LongEntity> : TasksManaged{
    ...
    fun pickById(id: Long, initiator: IdentifiableContext): ResultSingle<DTO, DATA, ENTITY>
    fun pick(conditions: SimpleQuery): ResultSingle<DTO, DATA, ENTITY>

    fun update(dataModels: List<DATA>,  initiator: IdentifiableContext): ResultList<DTO, DATA, ENTITY>

    fun update(dataModel: DATA,  initiator: IdentifiableContext): ResultSingle<DTO, DATA, ENTITY>

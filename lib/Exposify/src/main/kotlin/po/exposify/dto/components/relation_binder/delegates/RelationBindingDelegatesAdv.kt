...
sealed class RelationBindingDelegateAdv<DTO, DATA, ENTITY, C_DTO, FD, FE, V>(
    protected val dto : CommonDTO<DTO, DATA, ENTITY>,
    protected val childModel: DTOClass<C_DTO, FD, FE>,
...
class OneToManyDelegateAdv<DTO, DATA, ENTITY, F_DTO, FD, FE>(
...
) : RelationBindingDelegateAdv<DTO, DATA, ENTITY, F_DTO, FD, FE, List<F_DTO>>(dto, childModel,  dataProperty.name)
        where DTO : ModelDTO, DATA : DataModel, ENTITY : LongEntity,
...
class OneToOneDelegateAdv<DTO, DATA, ENTITY, F_DTO, FD, FE>(
    dto : CommonDTO<DTO, DATA, ENTITY>,
    childModel: DTOClass<F_DTO, FD, FE>,
    private val dataProperty: KMutableProperty1<DATA, FD>,
    private val entityProperty: KMutableProperty1<ENTITY, FE>,
) : RelationBindingDelegateAdv<DTO, DATA, ENTITY, F_DTO, FD, FE, F_DTO>(dto, childModel,  dataProperty.name)
        where DTO : ModelDTO, DATA : DataModel, ENTITY : LongEntity,
              F_DTO: ModelDTO,  FD : DataModel, FE : LongEntity {

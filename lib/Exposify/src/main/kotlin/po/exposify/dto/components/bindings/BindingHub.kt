...
{
    override val qualifiedName: String = "BindingHub[${hostingDTO.dtoName}]"
    val dtoClass : DTOBase<DTO, D, E>  get() = hostingDTO.dtoClass
    val daoService: DAOService<DTO, D, E> get() = hostingDTO.daoService

    internal val complexDelegateMap : MutableMap<String, ComplexDelegate<DTO, D, E, F_DTO,  FD,  FE>> = mutableMapOf()

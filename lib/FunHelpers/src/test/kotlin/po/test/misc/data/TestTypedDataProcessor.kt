...
import po.misc.data.processors.TypedDataProcessor
...
class TestTypedDataProcessor {
    ...
    val topDataProcessor: TypedDataProcessor<TopDataItem> = TypedDataProcessor()
    val subDataProcessor: TypedDataProcessor<DataItem> = TypedDataProcessor(topDataProcessor)
    ...
    fun `Data propagated to topDataProcessor and stacked within PrintableBase`(){
        ...
        topDataProcessor.onNewRecord {topRecord = it }

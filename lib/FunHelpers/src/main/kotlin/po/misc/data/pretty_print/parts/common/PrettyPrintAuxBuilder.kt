...
interface PrettyPrintAuxBuilder{
    ...
    fun <E: Enum<E>> String.toTaggedSeparator(tag: E, styleCode: StyleCode? = null): TaggedSeparator<E> =
        TaggedSeparator(tag, this, styleCode, 1)

    fun <E: Enum<E>> String.toTaggedSeparator(tag: E, repeat: Int,  styleCode: StyleCode? = null): TaggedSeparator<E> =

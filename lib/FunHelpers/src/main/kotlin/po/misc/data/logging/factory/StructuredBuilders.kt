...
fun LogSubject.toLogMessage(ctx: TraceableContext, Topic: Topic? = null): LogMessage{
    return LogMessage(ctx, subjectName, subjectText,  Topic?:topic)
}

fun RunSubject.toLogMessage(): LogMessage{
    return LogMessage(context, subjectName, subjectText, Topic.Info)
}

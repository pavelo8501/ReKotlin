...
//}
//
//abstract class CallbackManagerBaseDepr<T: Any, R: Any> {
//
//    abstract val ownName: String
//
//     protected open val subscriptions : MutableMap<CompositeKey, CallbackPayloadBase<T, R>> = mutableMapOf()
//
//    var onNewSubscription: ((ManagerStatsDepr)-> Unit)? = null
//    var onBeforeTrigger: ((TriggerEventDepr<T>)-> Unit)? = null
//    var onAfterTriggered: ((PostTriggerEventDepr)-> Unit)? = null
//

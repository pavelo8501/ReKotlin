...
enum class AuthErrorCodes(val code: Int) {
    ...
    INVALID_TOKEN(1003),
    TOKEN_EXPIRED(104),
    TOKEN_ISSUER_MISMATCH(1005),
    TOKEN_AUDIENCE_MISMATCH(1006),
    TOKEN_SIGNATURE_MISMATCH(1007),
    TOKEN_REVOKED(1008),
    TOKEN_INVALID_CLAIM(1009),
    TOKEN_INVALID_USER(1010),
    TOKEN_INVALID_ROLE(1011),
    TOKEN_INVALID_PERMISSION(1012),
    TOKEN_INVALID_AUDIENCE(1013),
    TOKEN_INVALID_ISSUER(1014),
    CONFIGURATION_MISSING(1015);
